...
return (new CustomEvent(event_name,(function (){var obj22547 = ({"detail":data});
return obj22547;
})()));
} else {
...
var f = (function (){var pred__22554 = cljs.core._EQ_;
var expr__22555 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__22554.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__22555))){
return ((function (pred__22554,expr__22555){
return (function (p1__22548_SHARP_){
return console.warn(p1__22548_SHARP_);
});
;})(pred__22554,expr__22555))
} else {
if(cljs.core.truth_(pred__22554.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__22555))){
return ((function (pred__22554,expr__22555){
return (function (p1__22549_SHARP_){
return console.debug(p1__22549_SHARP_);
});
;})(pred__22554,expr__22555))
} else {
if(cljs.core.truth_(pred__22554.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__22555))){
return ((function (pred__22554,expr__22555){
return (function (p1__22550_SHARP_){
return console.error(p1__22550_SHARP_);
});
;})(pred__22554,expr__22555))
} else {
return ((function (pred__22554,expr__22555){
return (function (p1__22551_SHARP_){
return console.log(p1__22551_SHARP_);
});
;})(pred__22554,expr__22555))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__22558){
...
var eval_fn = cljs.core.get.call(null,map__22559__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__22561_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__22563,(0),null);
var v = cljs.core.nth.call(null,vec__22563,(1),null);
...
}catch (e22568){if((e22568 instanceof Error)){
var e = e22568;
return not_found;
} else {
throw e22568;
...
//# sourceMappingURL=utils.js.map?rel=1616194468057

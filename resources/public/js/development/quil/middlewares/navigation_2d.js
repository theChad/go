...
return cljs.core.merge.call(null,initial_state,p1__2887_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_2888 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_2889 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_2888);
var pos_2890 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_2888);
quil.core.scale.call(null,zoom_2889);

var tr__1616__auto___2891 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_2889) - cljs.core.first.call(null,pos_2890)),(((quil.core.height.call(null) / (2)) / zoom_2889) - cljs.core.second.call(null,pos_2890))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__1616__auto___2891);

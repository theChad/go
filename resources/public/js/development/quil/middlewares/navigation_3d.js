...
var vec__2836 = axis;
var a_x = cljs.core.nth.call(null,vec__2836,(0),null);
var a_y = cljs.core.nth.call(null,vec__2836,(1),null);
var a_z = cljs.core.nth.call(null,vec__2836,(2),null);
var vec__2839 = v;
var x = cljs.core.nth.call(null,vec__2839,(0),null);
var y = cljs.core.nth.call(null,vec__2839,(1),null);
var z = cljs.core.nth.call(null,vec__2839,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__2842,p__2843){
var vec__2844 = p__2842;
var u1 = cljs.core.nth.call(null,vec__2844,(0),null);
var u2 = cljs.core.nth.call(null,vec__2844,(1),null);
var u3 = cljs.core.nth.call(null,vec__2844,(2),null);
var vec__2847 = p__2843;
var v1 = cljs.core.nth.call(null,vec__2847,(0),null);
var v2 = cljs.core.nth.call(null,vec__2847,(1),null);
var v3 = cljs.core.nth.call(null,vec__2847,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__2850_SHARP_){
return (p1__2850_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__2851_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__2852_SHARP_,angle_lr),angle_ud);
...
var map__2854 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2854__$1 = (((((!((map__2854 == null))))?(((((map__2854.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2854.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2854):map__2854);
var up = cljs.core.get.call(null,map__2854__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__2854__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5751__auto__ = (function (){var pred__2856 = cljs.core._EQ_;
var expr__2857 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__2856.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__2857))){
return straight;
} else {
if(cljs.core.truth_(pred__2856.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__2857))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__2856.call(null,quil.middlewares.navigation_3d.space,expr__2857))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__2856.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__2857))){
return up;
} else {
if(cljs.core.truth_(pred__2856.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__2857))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__2856.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__2857))){
...
var dir = temp__5751__auto__;
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5751__auto__,map__2854,map__2854__$1,up,straight){
return (function (p1__2853_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__2853_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5751__auto__,map__2854,map__2854__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__2859_SHARP_);
});})(initial_state))
);
});
/**
...
var map__2860_2871 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2860_2872__$1 = (((((!((map__2860_2871 == null))))?(((((map__2860_2871.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2860_2871.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2860_2871):map__2860_2871);
var vec__2861_2873 = cljs.core.get.call(null,map__2860_2872__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_2874 = cljs.core.nth.call(null,vec__2861_2873,(0),null);
var c_y_2875 = cljs.core.nth.call(null,vec__2861_2873,(1),null);
var c_z_2876 = cljs.core.nth.call(null,vec__2861_2873,(2),null);
var vec__2864_2877 = cljs.core.get.call(null,map__2860_2872__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_2878 = cljs.core.nth.call(null,vec__2864_2877,(0),null);
var u_y_2879 = cljs.core.nth.call(null,vec__2864_2877,(1),null);
var u_z_2880 = cljs.core.nth.call(null,vec__2864_2877,(2),null);
var vec__2867_2881 = cljs.core.get.call(null,map__2860_2872__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_2882 = cljs.core.nth.call(null,vec__2867_2881,(0),null);
var p_y_2883 = cljs.core.nth.call(null,vec__2867_2881,(1),null);
var p_z_2884 = cljs.core.nth.call(null,vec__2867_2881,(2),null);
quil.core.camera.call(null,p_x_2882,p_y_2883,p_z_2884,(p_x_2882 + c_x_2874),(p_y_2883 + c_y_2875),(p_z_2884 + c_z_2876),u_x_2878,u_y_2879,u_z_2880);
